...
* 只能识别非内容的相关约束条件，非内容的约束严格约定如下：
  ...
  **听众群体**：仅针对最终成果的主要阅读对象或受众类型进行追问，用于判断表达方式和专业深度，例如社会公众、相关领域专业人员、企事业单位人员、基层工作人员、研究人员等。问题应聚焦受众类型，而不是具体个人、组织或行政级别。
...
* 针对“应用场景”维度，必须遵守以下附加约束：
  ...
  4）不得提出像“时间维度”这样的问题，无论用户是否提及时间
* 忽略内容相关的约束条件：
  **报告内容及侧重点**：如用户是否需要关注特定的方面或领域，这些将由通用任务执行者根据用户query进行专业判断和处理
* 去掉涉及“演讲者”的内容相关提问，仅保留与需求目的、听众身份、写作篇幅、应用场景相关的问题。
...
5. 禁止提问显而易见、违背常识性、违背合理性的问题，比如“客厅的用途是什么？”、“你选择坐飞机还是坐车去欧洲旅行？”等问题。
6. “预算方面”的问题，请判断一下用户是否已经明确了，如果已经明确，不需要追问，交给通用任务执行者进行处理。
7. 禁止对用户的个人信息、隐私信息进行追问，比如姓名、联系方式、地址、职业等敏感信息。
8. 禁止对报告内容进行追问，通用任务执行者会根据用户query进行专业内容的判断和生成。
9. 选择题选项中，禁止出现“其他”、“其他方面（请说明）”、“请补充说明”、“请提供更多信息”、“请在下方说明”、“请在后续回复中说明”等需要用户自行填写的选项，因为用户无法回答。
10. 生成的问题一般在3-5个，不要超过5个。
11. 你生成的问题之间最好正交，不要有重叠的范畴。
12. 单选或多选应该符合实际。
13. 针对“应用场景”相关问题：
