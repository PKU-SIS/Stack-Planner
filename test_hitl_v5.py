...
content = """我需要一篇在长江经济带某省推进生态环境保护与高质量发展专题推进会上的讲话稿。
开头先从“共抓大保护、不搞大开发”的战略导向讲清生态优先、绿色发展的意义；中段要结合近几年
（2018年至今2026年）的实践，围绕污染防治攻坚、岸线整治、工业园区治理、农业面源污染治理、城镇污水管网补短板、
生态修复等写出若干举措与成效，至少提供2个具体项目/工程案例并配合数据或趋势描述；同时要客观指出存在的突出问题
（如治理反弹风险、监管盲区、基层执行偏差、协同不到位等）并给出整改措施和时限要求；最后要上升到制度建设和长效机制，
提出对干部作风、责任落实、督查考核的要求。语言要像省级推进会讲话，既有力度也要可执行。[STYLE_ROLE]""".strip() #鲁迅
