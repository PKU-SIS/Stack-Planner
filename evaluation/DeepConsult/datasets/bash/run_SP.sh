...
export OPENAI_BASE_URL="https://dashscope.aliyuncs.com/compatible-mode/v1"  # Or the URL of your custom server


# Running the Python evaluation script
python -m evals.deep_research_pairwise_evals \
  --input-data datasets/DeepConsult/responses_SP_vs_Baseline.csv \
