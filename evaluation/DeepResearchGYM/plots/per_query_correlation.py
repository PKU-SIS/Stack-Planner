...
for idx, (sys, color) in enumerate(zip(SYSTEMS, COLORS)):
    ...
    for qid in common_ids:
        ...
        quality_vals_orig = [
            detailed_scores_orig[metric][0] for metric in holistic_metrics
        ]
        quality_vals_custom = [
            detailed_scores_custom[metric][0] for metric in holistic_metrics
        ]
