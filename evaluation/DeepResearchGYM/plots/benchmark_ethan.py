...
def benchmark_search_rps(
    n=100, k=100, search_url=None, parallel=False, num_threads=10, query_length=50
):
    """
    ...
    if parallel:
        with ThreadPoolExecutor(max_workers=num_threads) as executor:
            ...
            future_to_query = {
                executor.submit(perform_search, query): query for query in queries
            }
    ...
    percentile_dict = {
        f"p{p}": value for p, value in zip(percentiles, percentile_values)
    }
