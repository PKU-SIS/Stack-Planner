...
linewidths = {"P50 (Median)": 2.5, "P90": 2.0, "P95": 1.7, "P99": 1.5}
...
plt.plot(
    ...
    p50_latency,
    label="P50 (Median)",
    color=colors["P50 (Median)"],
    linestyle="-",
    marker=markers["P50 (Median)"],
    linewidth=linewidths["P50 (Median)"],
)
