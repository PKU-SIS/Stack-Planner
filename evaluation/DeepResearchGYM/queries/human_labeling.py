...
custom_systems = [
    "GPTResearcher_custom",
    "hf_deepresearch_gpt-4o-mini_custom",
    "open_deep_search_custom",
    "search-r1-custom",
    "search-o1_custom",
]
...
print(
    f"Created folder structure under {output_root} for annotators and saved summary file."
)
