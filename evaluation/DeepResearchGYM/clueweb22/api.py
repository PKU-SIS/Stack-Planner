...
class ClueWeb22Api:
    ...
    def get_node_features(self):
        cw22id = self.cw22id
        cw22root_path = self.cw22root_path
        base_filename = self.get_base_filename_by_id(
            cw22id, cw22root_path, file_type="vdom"
        )
        ...
        with zipfile.ZipFile(vdom_path, "r") as z:
            ...
            with z.open(filename) as f:
                ...
                api = AnnotateHtmlApi(
                    annotate_html, init_nodes=False, html_string=html_string
                )
    ...
    def get_node_features_with_text(self, is_primary=True):
        ...
        with zipfile.ZipFile(vdom_path, "r") as z:
            ...
            with z.open(filename) as f:
                ...
                html_string = self.get_html_from_warc()
                api = AnnotateHtmlApi(
                    annotate_html, init_nodes=True, html_string=html_string
                )
    ...
    def get_json_record(self, record_type):
        ...
        cw22root_path = self.cw22root_path
        base_filename = self.get_base_filename_by_id(
            cw22id, cw22root_path, file_type=record_type
        )
