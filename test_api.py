...
# 请仿照以上内容的格式，写一段关于全面从严治党的实施意见，请多引用习近平总书记的讲话，请你一定要搜索，进入researcher_team，不要生成网络引用，而是使用源文件名称"""

content = """请写一段关于全面建成小康社会的实施意见，请你一定要搜索，进入researcher_team，不要生成网络引用，而是使用源文件名称。"""
